...
return function(){var n=["a[href]","area[href]",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])","button:not([disabled])","iframe","object","embed","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],i=function(){function i(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=t.targetModal,r=t.triggers,a=void 0===r?[]:r,l=t.disableScroll,c=void 0!==l&&l,s=(t.debugMode,t.onShow),u=void 0===s?function(){}:s,d=t.onClose,f=void 0===d?function(){}:d
e(this,i),this.modal=document.getElementById(n),a.length>0&&this.registerTriggers.apply(this,o(a)),this.disableScroll=c,this.callbacks={onShow:u,onClose:f},this.onClick=this.onClick.bind(this),this.onKeydown=this.onKeydown.bind(this)}return t(i,[{key:"registerTriggers",value:function(){for(var e=this,t=arguments.length,o=Array(t),n=0;n<t;n++)o[n]=arguments[n]
...
void 0===t[o]&&(t[o]=[]),t[o].push(e)}),t},a=function(e){if(!document.getElementById(e))return console.warn("MicroModal v0.1.1: ❗Seems like you have missed %c'"+e+"'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","ID somewhere in your code. Refer example below to resolve it."),console.warn("%cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<div class="modal" id="'+e+'"></div>'),!1},l=function(e){if(e.length<=0)return console.warn("MicroModal v0.1.1: ❗Please specify at least one %c'micromodal-trigger'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","data attribute."),console.warn("%cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<a href="#" data-micromodal-trigger="my-modal"></a>'),!1},c=function(e,t){if(l(e),!t)return!0
for(var o in t)a(o)
return!0}
return{init:function(e){var t=e||{},n=document.querySelectorAll("[data-micromodal-trigger]"),a=r(n)
if(!0!==t.debugMode||!1!==c(n,a))for(var l in a){var s=a[l]
t.targetModal=l,t.triggers=[].concat(o(s)),new i(t)}},show:function(e,t){var o=t||{}
o.targetModal=e,(!0!==o.debugMode||!1!==a(e))&&new i(o).showModal()}}}()})
