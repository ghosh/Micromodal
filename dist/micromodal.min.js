...
void 0===t[o]&&(t[o]=[]),t[o].push(e)}),t},a=function(e,t,o){if(o){if(e.length<=0)return console.warn("MicroModal v0.1.1: ❗Please specify at least one %c'micromodal-trigger'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","data attribute."),console.warn("%cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<a href="#" data-micromodal-trigger="my-modal"></a>'),!1
for(var n in t)if(!document.getElementById(n))return console.warn("MicroModal v0.1.1: ❗Seems like you have missed %c'"+n+"'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","ID somewhere in your code. Refer example below to resolve it."),console.warn("%cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<div class="modal" id="'+n+'"></div>'),!1}return!0}
return{init:function(e){var t=e||{},n=document.querySelectorAll("[data-micromodal-trigger]"),c=i(n),l=t.debugMode||!1
if(a(n,c,l))for(var s in c){var u=c[s]
t.targetModal=s,t.triggers=[].concat(o(u)),new r(t)}},show:function(e){new r({targetModal:e}).showModal()}}}()})
