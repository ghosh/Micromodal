...
return function(){var n=["a[href]","area[href]",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])","button:not([disabled])","iframe","object","embed","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],i=function(){function i(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=t.targetModal,r=t.triggers,a=void 0===r?[]:r,s=t.disableScroll,l=void 0!==s&&s,c=(t.debugMode,t.onShow),d=void 0===c?function(){}:c,u=t.onClose,f=void 0===u?function(){}:u,h=(t.openTrigger,t.closeTrigger),v=void 0===h?"data-micromodal-close":h
e(this,i),this.modal=document.getElementById(n),a.length>0&&this.registerTriggers.apply(this,o(a)),this.disableScroll=l,this.closeTrigger=v,this.callbacks={onShow:d,onClose:f},this.onClick=this.onClick.bind(this),this.onKeydown=this.onKeydown.bind(this)}return t(i,[{key:"registerTriggers",value:function(){for(var e=this,t=arguments.length,o=Array(t),n=0;n<t;n++)o[n]=arguments[n]
...
return e.forEach(function(e){var n=t&&e.attributes[t].value||e.dataset.micromodalTrigger
...
for(var o in t)a(o)
return!0},c=function(e){var t=e||{},n=[].concat(o(document.querySelectorAll(!!t.openTrigger&&"["+t.openTrigger+"]"||"[data-micromodal-trigger]"))),a=r(n,t.openTrigger)
