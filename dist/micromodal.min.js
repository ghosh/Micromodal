...
return function(){var n=["a[href]","area[href]","input:not([disabled])","select:not([disabled])","textarea:not([disabled])","button:not([disabled])","iframe","object","embed","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],i=function(){function i(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=t.targetModal,r=t.triggers,a=void 0===r?[]:r,s=t.onShow,c=void 0===s?function(){}:s,l=t.onClose,d=void 0===l?function(){}:l
e(this,i),this.modal=document.getElementById(n),a.length>0&&this.registerTriggers.apply(this,o(a)),this.callbacks={onShow:c,onClose:d},this.onClick=this.onClick.bind(this),this.onKeydown=this.onKeydown.bind(this)}return t(i,[{key:"registerTriggers",value:function(){for(var e=this,t=arguments.length,o=Array(t),n=0;n<t;n++)o[n]=arguments[n]
...
e.shiftKey&&0===o&&(t[t.length-1].focus(),e.preventDefault()),e.shiftKey||o!==t.length-1||(t[0].focus(),e.preventDefault())}}]),i}(),r=function(e,t){return!(t.length<=0)||(console.warn("MicroModal v0.1.0: ❗Please specify at least one %c'micromodal-trigger'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","data attribute."),console.warn("MicroModal v0.1.0: %cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<a href="#" data-micromodal-trigger="'+t+'"></a>'),!1)},a=function(e){var t=[]
...
t.targetModal=c,t.triggers=[].concat(o(l)),new i(t)}}},show:function(e){new i({targetModal:e}).showModal()}}}()})
