...
this.activeElement=document.activeElement,this.modal.setAttribute("aria-hidden","true"),this.removeEventListeners(),this.scrollBehaviour("enable"),this.activeElement.focus(),this.config.onClose(this.modal),this.config.awaitCloseAnimation?this.modal.addEventListener("animationend",function t(){e.classList.remove("is-open"),e.removeEventListener("animationend",t,!1)},!1):e.classList.remove("is-open")}},{key:"scrollBehaviour",value:function(e){if(this.config.disableScroll){var t=document.querySelector("body")
...
for(var o in t)s(o)
return!0}
return{init:function(e){var t=Object.assign({},{openTrigger:"data-micromodal-trigger"},e),n=[].concat(o(document.querySelectorAll("["+t.openTrigger+"]"))),a=r(n,t.openTrigger)
if(!0!==t.debugMode||!1!==c(n,a))for(var s in a){var l=a[s]
t.targetModal=s,t.triggers=[].concat(o(l)),new i(t)}},show:function(e,t){var o=t||{}
o.targetModal=e,!0===o.debugMode&&!1===s(e)||(a=new i(o),a.showModal())},close:function(e){var t={}
null===a&&(t.targetModal=e,a=new i(t)),a.closeModal()}}}()})
