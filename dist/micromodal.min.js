...
void 0===t[o]&&(t[o]=[]),t[o].push(e)}),t},a=function(e){if(e<=0)return console.warn("MicroModal v0.1.0: ❗Please specify at least one %c'micromodal-trigger'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","data attribute."),console.warn("MicroModal v0.1.0: %cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<a href="#" data-micromodal-trigger="my-modal"></a>'),!1
var t=i(e)
for(var o in t)if(!document.getElementById(o))return console.warn("MicroModal v0.1.0: ❗Seems like you have missed %c'"+o+"'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","ID somewhere in your code. Refer example below to resolve it."),console.warn("MicroModal v0.1.0: %cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<div class="modal" id="'+o+'"></div>'),!1
return!0}
return{init:function(e){var t=e||{},n=document.querySelectorAll("[data-micromodal-trigger]")
if(a(n)){var c=i(n)
for(var l in c){var s=c[l]
