...
for(var o in t)if(!document.getElementById(o))return console.warn("MicroModal v0.1.1: ❗Seems like you have missed %c'"+o+"'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","ID somewhere in your code. Refer example below to resolve it."),console.warn("%cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<div class="modal" id="'+o+'"></div>'),!1
return!0}
return{init:function(e){var t=e||{},n=document.querySelectorAll("[data-micromodal-trigger]"),c=i(n)
if(!0!==t.debugMode||!1!==a(n,c))for(var l in c){var s=c[l]
