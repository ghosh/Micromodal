...
return function(){var n=["a[href]","area[href]","input:not([disabled])","select:not([disabled])","textarea:not([disabled])","button:not([disabled])","iframe","object","embed","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],r=function(){function r(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},n=t.targetModal,i=t.triggers,a=void 0===i?[]:i,c=t.noScroll,l=void 0!==c&&c,s=t.onShow,u=void 0===s?function(){}:s,d=t.onClose,f=void 0===d?function(){}:d
e(this,r),this.modal=document.getElementById(n),a.length>0&&this.registerTriggers.apply(this,o(a)),this.noScroll=l,this.callbacks={onShow:u,onClose:f},this.onClick=this.onClick.bind(this),this.onKeydown=this.onKeydown.bind(this)}return t(r,[{key:"registerTriggers",value:function(){for(var e=this,t=arguments.length,o=Array(t),n=0;n<t;n++)o[n]=arguments[n]
